...
export interface PaymentOption {
  ...
  amountCents: number;
  currency: "EUR";
  paymentUrl: TrustedStripePaymentUrl;
}
    ...
    paymentOptions: [
      {
        ...
        amountCents: 4_000,
        currency: "EUR",
        paymentUrl: trustedStripePaymentUrl("https://buy.stripe.com/dRm8wH8lDf0KfxG8OO97G07"),
      },
    ],
  },
  {
    ...
    paymentOptions: [
      {
        ...
        amountCents: 16_000,
        currency: "EUR",
        paymentUrl: trustedStripePaymentUrl("https://buy.stripe.com/7sYcMXcBT5qa99i8OO97G04"),
      },
    ],
  },
  {
    ...
    paymentOptions: [
      {
        ...
        amountCents: 7_000,
        currency: "EUR",
        paymentUrl: trustedStripePaymentUrl("https://buy.stripe.com/bJefZ96dv3i21GQaWW97G05"),
      },
    ],
  },
  {
    ...
    paymentOptions: [
      {
        ...
        amountCents: 8_000,
        currency: "EUR",
        paymentUrl: trustedStripePaymentUrl("https://buy.stripe.com/28E00b0Tb2dYetCc1097G06"),
      },
    ],
  },
  {
    ...
    paymentOptions: [
      {
        ...
        amountCents: 2_200,
        currency: "EUR",
        paymentUrl: trustedStripePaymentUrl("https://book.stripe.com/6oU3cn6dv9Gq5X6aWW97G08"),
      },
      {
        key: "consulting_60",
        minutes: 60,
        amountCents: 4_300,
        currency: "EUR",
        paymentUrl: trustedStripePaymentUrl("https://book.stripe.com/aFa9AL6dv05Q5X6aWW97G0a"),
      },
      {
        key: "consulting_90",
        minutes: 90,
        amountCents: 6_600,
        currency: "EUR",
        paymentUrl: trustedStripePaymentUrl("https://book.stripe.com/28EdR131j7yigBK8OO97G09"),
      },
    ],
  },
]);
